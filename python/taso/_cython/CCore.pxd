...
#        SplitInfo split[MAX_DIM]
    ...
    cdef cppclass Graph:
        ...
        vector[vector[int]] get_vertex_weight();
        ...
        Graph* optimize_partition(float alpha, int budget, bool print_subst, int eraly_stop_num, vector[vector[vector[int]]] partitions, bool do_weight_process)
